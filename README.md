...
- ⚙️ Sets macOS developer preferences

## 📦 Packages

**🔧 CLI:** git, nvm, pnpm, redis, uv, wget, yarn, zsh-autosuggestions, zsh-syntax-highlighting, commitizen
